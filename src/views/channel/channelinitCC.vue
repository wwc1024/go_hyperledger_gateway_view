    ...
    <el-row>
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span v-if="isEdit===false">init初始化合约</span>
        ...
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="ChaincodeID:">
              <el-input v-model="form.chaincodeid" placeholder="myccc" />
            </el-form-item>
            <el-form-item label="Fcn:">
              <el-input v-model="form.fcn" placeholder="InitLedger" />
            </el-form-item>
            <el-form-item label="Args:">
              <el-input v-model="form.args" placeholder="" />
            </el-form-item>
...
<script>
import { channelInitCC } from '@/api/channel'
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (this.isEdit) {
        ...
        channelInitCC(query).then(response => {
          this.submitButDisabled = false
          this.$notify({
            title: 'Success',
            message: 'initCC success',
            type: 'success',
            duration: 2000
          })
        }).catch(() => {
