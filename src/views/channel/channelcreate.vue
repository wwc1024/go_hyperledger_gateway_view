      ...
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="sdkConfigPath">
              <el-input v-model="form.channel_configPath" :disabled="isEdit===true" placeholder="路径格式:./config2.yaml" class="input-with-select">
                <el-select slot="prepend" v-model="form.channel_configPath" placeholder="请选择" style="width:80px" :disabled="isEdit===true">
            ...
            <!-- <el-form-item label="sdkConfigPath" >
              <el-input v-model="form.channel_configPath" placeholder="ConfigPath" />
            </el-form-item> -->
            ...
            <el-form-item label="ChannelId">
              <el-input v-model="form.channel_channelId" placeholder="mychannel" />
            </el-form-item>
  ...
  data() {
    return {
      ...
      form: {
        ...
        channel_peerNam: undefined,
        channel_channelId: undefined
      }
    }
  },
  created() {
