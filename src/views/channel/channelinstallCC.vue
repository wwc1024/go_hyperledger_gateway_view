    ...
    <el-row>
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span v-if="isEdit===false">安装链码</span>
        ...
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="ConfigPath">
              <el-input v-model="form.channel_configPath" placeholder="./config2.yaml" />
            </el-form-item>
            <el-form-item label="OrgAdmin">
              <el-input v-model="form.channel_orgAdmin" placeholder="Admin" />
            </el-form-item>
            <el-form-item label="OrgName">
              <el-input v-model="form.channel_orgName" placeholder="Org1" />
            </el-form-item>
            <el-form-item label="ChannelConfigTxFile">
              <el-input v-model="form.channel_channelConfigTxFile" placeholder="../../../../../../../channel-artifacts/channeltwo.tx" />
            </el-form-item>
            <el-form-item label="PeerName">
              <el-input v-model="form.channel_peerName" placeholder="peer0.org1.example.com" />
            </el-form-item>
            <el-form-item label="OrderName">
              <el-input v-model="form.channel_orderName" placeholder="OrderName" />
            </el-form-item>
            <el-form-item label="ChannelId2">
              <el-input v-model="form.channel_channelId2" placeholder="mychanneltwo" />
            </el-form-item>

            <el-form-item label="OrgMsp">
              <el-input v-model="form.channel_orgMsp" placeholder="OrgMsp" />
            </el-form-item>
            <el-form-item label="CcID">
              <el-input v-model="form.channel_ccID" placeholder="CcID" />
            </el-form-item>
            <el-form-item label="CcVersion">
              <el-input v-model="form.channel_ccVersion" placeholder="CcVersion" />
            </el-form-item>
            <el-form-item label="Ccpath">
              <el-input v-model="form.channel_ccpath" placeholder="Ccpath" />
            </el-form-item>
...
<script>
import { channelInstallCC } from '@/api/channel'
export default {
  name: 'ChannelInstallCC',
  data() {
    return {
      isEdit: false,
      submitButDisabled: false,
      form: {
        channel_configPath: undefined,
        channel_orgAdmin: undefined,
        channel_orgName: undefined,
        channel_channelConfigTxFile: undefined,
        channel_peerName: undefined,
        channel_channelId2: undefined,
        channel_orderName: undefined,
        channel_orgMsp: undefined,
        channel_ccID: undefined,
        channel_ccVersion: undefined,
        channel_ccpath: undefined
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (this.isEdit) {
        ...
        channelInstallCC(query).then(response => {
          this.submitButDisabled = false
          this.$notify({
            title: 'Success',
            message: '安装链码',
